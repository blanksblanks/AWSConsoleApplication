...
public class AwsConsoleApp {
     ...
     *      (/Users/blanks/.aws/credentials) where the sample code will load the
     *      credentials from.
    ...
    private static void init() throws Exception {
        ...
        try {
            ...
            throw new AmazonClientException(
                    ...
                    "location (/Users/blanks/.aws/credentials), and is in valid format.",
                    e);
        }
